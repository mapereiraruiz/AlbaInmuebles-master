...
{
    public class MantenimientoListadoBajasVM : ObservableViewModel, IPageViewModel
    {
        protected new ICommand _modifyCommand;

        private HomeListadoBajasVM baseVM;
        ...
        public  string Name
        {
            get
            {
                return "Mantenimiento Listado Bajas";
            }
        }

        public MantenimientoListadoBajasVM(HomeListadoBajasVM baseVM)
        {
            this.baseVM = baseVM;          
        }

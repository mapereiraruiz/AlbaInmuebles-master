...
{
    public class FichaContratoClienteFacturacionVM : ObservableViewModel, IPageViewModel, IDataErrorInfo
	{
		...
		public FichaContratoClienteFacturacionVM(FichaContratoClienteVM baseVM, ContratosClientes entitybase, Facturacion entity = null)
		{
		...
		public string Name
        {
            get
            {
                 return "Ficha Contrato Cliente Facturación";
            }
        }
        ...
        {
			base.VolverListado();
			var viewmodel = baseVM.PageViewModels.Where(m => m.Name == "Contrato Cliente Facturas").FirstOrDefault();
			viewmodel = new ContratoClienteFacturasVM(baseVM, entitybase);

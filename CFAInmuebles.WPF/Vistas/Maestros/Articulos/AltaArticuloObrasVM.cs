...
{
    public class AltaArticuloObrasVM : ObservableViewModel, IPageViewModel, IDataErrorInfo
    {
        ...
        public AltaArticuloObrasVM(FichaArticulosVM baseVM, Articulos entitybase, HistorialObra entidad = null)
        {
        ...
        protected override void LoadData()
        {
            ...
            if (entity.IdHistorialObra > 0)
            {
                ...
                Trazabilidad("Maestros", "Artículos", Descripcion, "Consulta", "Ficha Artículo Obra");
            }
        ...
        protected override void ModifyData()
        {
            ...
            if (Errors.Count == 0)
            {
                ...
                model.IdTipoFicheroNavigation = db.TipoFichero.Where(m => m.Valor == "Artículo").FirstOrDefault();
                ...
                model.IdFichero = entitybase.IdArticulo;
                db.SaveChanges();
                ...
                db.SaveChanges();
                Trazabilidad("Mantenimientos", "Historial Obras", Descripcion, accion, "Alta Artículos Obras");
                baseVM.ChangePageCommand.Execute(baseVM.PageViewModels.Where(m => m.Name == "Artículo Obras").FirstOrDefault());
            }
        ...
        protected override void VolverListado()
        {
            ...
            var viewmodel = baseVM.PageViewModels.Where(m => m.Name == "Artículo Obras").FirstOrDefault();
            viewmodel = new ArticuloObrasVM(baseVM, entitybase);

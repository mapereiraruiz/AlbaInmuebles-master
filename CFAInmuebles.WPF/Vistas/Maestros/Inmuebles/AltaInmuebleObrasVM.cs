...
{
    public class AltaInmuebleObrasVM : ObservableViewModel, IPageViewModel, IDataErrorInfo
    {
        ...
        public AltaInmuebleObrasVM(FichaInmueblesVM baseVM, Inmuebles entitybase, HistorialObra entidad = null)
        {
        ...
        protected override void LoadData()
        {
            ...
            if (entity.IdHistorialObra > 0)
            {
                ...
                Trazabilidad("Maestros", "Inmuebles", Descripcion, "Consulta", "Ficha Inmueble Obra");
            }
        ...
        protected override void ModifyData()
        {
            ...
            if (Errors.Count == 0)
            {
                ...
                db.SaveChanges();
                Trazabilidad("Maestros", "Inmuebles", Descripcion, "Alta", "Ficha Obra");
        ...
        protected override void VolverListado()
        {
            ...
            var viewmodel = baseVM.PageViewModels.Where(m => m.Name == "Inmueble Obras").FirstOrDefault();
            viewmodel = new InmuebleObrasVM(baseVM, entitybase);

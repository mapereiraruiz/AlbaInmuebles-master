...
{
    public class AltaContactoInmuebleVM : ObservableViewModel, IPageViewModel, IDataErrorInfo
	{
		...
		public AltaContactoInmuebleVM(FichaInmueblesVM baseVM, Inmuebles entitybase, Contactos entity = null)
		{
		...
		protected override void LoadData()
        {
			...
			if (entity.IdContacto > 0)
			{
				...
				Trazabilidad("Maestros", "Inmuebles", entity.Contacto, "Consulta", "Mantenimiento Contacto Inmueble");
			}
        }
		...
		protected override void ModifyData()
		{
			...
			if (Errors.Count == 0)
			{
                ...
                db.SaveChanges();
                Trazabilidad("Maestros", "Inmuebles", Contacto, accion, "Contacto");
		...
		protected override void DeleteData()
        {
            ...
            if (entity.IdContacto > 0)
            {
                var viewmodel = PageViewModels.Where(m => m.Name == "Eliminar Contacto Inmueble").FirstOrDefault();
                viewmodel = new DeleteContactoInmuebleVM(baseVM, entity);
        ...
        protected override void VolverListado()
        {
            ...
            var viewmodel = baseVM.PageViewModels.Where(m => m.Name == "Inmueble Contactos").FirstOrDefault();
            viewmodel = new InmuebleContactosVM(baseVM, entitybase);
            baseVM.CurrentPageViewModel = viewmodel;
        }

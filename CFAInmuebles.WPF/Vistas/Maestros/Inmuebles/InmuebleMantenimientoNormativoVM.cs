...
{
    public class InmuebleMantenimientoNormativoVM : ObservableViewModel, IPageViewModel
    {
        ...
        public InmuebleMantenimientoNormativoVM(HomeInmueblesVM baseVM, Inmuebles entity = null)
        {
            this.entity = entity;
            this.baseVM = baseVM;
        }
        public string Name
        {
            get
            {
                return "Inmueble Mantenimiento Normativo";
            }
        }
        ...
        protected override void LoadData()
        {
            ...
            {
                Mantenimientos = db.Mantenimientos.Where(m => m.FechaEliminacion == null && m.IdTipoMantenimientoNavigation.Valor == "Normativo" && m.IdFichero == entity.IdInmueble).ToList();
                Trazabilidad("Maestros", "Inmuebles", entity.Inmueble, "Consulta", "Mantenimiento Inmuebles Mantenimientos Normativos");
            }
        }

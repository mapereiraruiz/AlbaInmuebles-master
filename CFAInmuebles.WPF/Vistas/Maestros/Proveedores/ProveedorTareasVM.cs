...
{
    public class ProveedorTareasVM : ObservableViewModel, IPageViewModel
    {
        ...
        public ProveedorTareasVM(HomeProveedoresVM baseVM, Terceros entity = null)
        {
            this.entity = entity;
            this.baseVM = baseVM;
        }
        ...
        protected override void LoadData()
        {
            ...
            if (entity != null)
            {
                TareasPeriodicas = db.TareaPeriodica.Where(m => m.FechaEliminacion == null && m.IdTipoFicheroNavigation.Valor == "Proveedor" && m.IdFichero == entity.Numero).ToList();

                Trazabilidad("Maestros", "Proveedores", entity.Nombre, "Consulta", "Mantenimiento Proveedores Tareas");
            }
        }

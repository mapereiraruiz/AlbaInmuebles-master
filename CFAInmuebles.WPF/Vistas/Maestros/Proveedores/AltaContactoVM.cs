...
{
    public class AltaContactoVM : ObservableViewModel, IPageViewModel, IDataErrorInfo
	{
		...
		public AltaContactoVM(FichaProveedoresVM baseVM, Terceros entitybase, Contactos entity = null)
		{
		...
		public string Name
        {
            get
            {
                 return "Alta Contacto Proveedor";
            }
        }
		...
		protected override void LoadData()
        {
			...
			if (entity.IdContacto > 0)
			{
				...
				Trazabilidad("Maestros", "Proveedores", entity.Contacto, "Consulta", "Mantenimiento Proveedor Contactos");
			}
        }
		...
		protected override void ModifyData()
		{
			...
			if (Errors.Count == 0)
			{
                ...
                model.Nif = Nif;             
                model.IdTipoFicheroNavigation = db.TipoFichero.Where(m => m.Valor == "Proveedor").FirstOrDefault();
                ...
                db.SaveChanges();
				Trazabilidad("Maestros", "Proveedores", Contacto, accion, "Ficha Proveedores");
		...
		protected override void DeleteData()
        {
            ...
            if (entity.IdContacto > 0)
            {
                var viewmodel = PageViewModels.Where(m => m.Name == "Eliminar Contacto").FirstOrDefault();
                viewmodel = new DeleteContactoVM(baseVM, entity);
        ...
        {
			base.VolverListado();
			var viewmodel = baseVM.PageViewModels.Where(m => m.Name == "Proveedor Contactos").FirstOrDefault();
			viewmodel = new ProveedorContactosVM(baseVM, entitybase);
			baseVM.CurrentPageViewModel = viewmodel;
		}
